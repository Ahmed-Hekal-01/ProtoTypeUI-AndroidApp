import { LogOut, ChevronRight, Mail, Phone, ArrowLeft, RefreshCw } from 'lucide-react';
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <p className="text-sm font-medium">Switch to Club Manager</p>
                  <p className="text-xs text-gray-500">Manage your club activities</p>
                </div>
              </div>
